...
export class UploadPhotoPage implements OnInit {
  ...
  constructor(private router: Router, private sessionService: SessionService, private camera: Camera, private file: File, private http: HttpClient, private webview: WebView,
  ...
  async uploadImageData(formData: FormData) {
    ...
    this.http.post<any>("/api/Photo/uploadPhoto?userId=" + this.sessionService.getCurrentUser().userId, formData)
      ...
      .subscribe(response => {
        ...
        this.router.navigate(["photo/editphotodetails/" + this.photoId]);
